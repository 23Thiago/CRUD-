...
<div class="container" id="tamanhoContainer" style="margin-top: 30px;">
			...
			<center>
			<h4>EDIÇÃO DE SOLICITANTES </h4>
			</center>
		<form action="atualizar_solicitantes.php" method="post" style= "margin-top: 20px;">
		...
		<div class="form-group">
   		 <!-- <label for="id_user">ID Solicitante:</label> -->
   		 <!-- <input type="number" class="form-control" name="id_user" value= "<?= $id_user ?>" disabled> -->
   		 <input type="hidden" class="form-control" name="id" value= "<?= $id ?>">
   		 <input type="hidden" class="form-control" name="action" value="editar">


		<div class="form-group">
   		 <label for="nome_user">Nome:</label>
   		 <input type="string" class="form-control" name="nome_user" value="<?= $nome_user ?>">
   		</div>
