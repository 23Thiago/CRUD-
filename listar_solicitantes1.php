...
<br>
	<div style="text-align: center;">
   	...
   	<tr>	
      	 ...
      	 <td>
		   <center>		   
		   <a class="btn btn-warning" style="color:#fff" href="editar_solicitantes1.php?id=<?php echo $id_user ?>" role="button"><i class="far fa-edit"></i>&nbsp;EDITAR</a>
		   <a class="btn btn-danger btn-sm" style="color:#fff" href="deletar_solicitantes.php?id=<?php echo $id_user ?> " role="button">&nbsp;EXCLUIR</a>  
		   </center>		   
		 </td>
      </tr>
